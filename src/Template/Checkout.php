                        ...
                        <div class="frame__contents">
                            <table class="order-summary">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="images/product.jpg" alt="Lorem Widget" class="product-image" />
                                        </td>
                                        <td>Lorem Widget</td>
                                        <td class="order-summary__quantity">1</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="frame__contents">
                            <div class="form-field">
                                <div class="form-field checkbox-field">
                                    <input type="checkbox" name="beta_program" id="beta_program" value="yes" />
                                    <label for="beta_program" class="checkbox-label">With our “Rise & Shine” beta program, you get early access to new features, but they may not always work perfectly. You can change your beta preference at any time after you join.</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="frame">
                        ...
                        <div class="frame__contents">
                            ...
                            <div class="form-field form-field--required">
                                ...
                                <div class="form-field__contents">
                                    <div class="textarea__container">
                                        <input type="text" name="billing_address_line1" id="billing_address_line1" class="entry" value="" placeholder="123 Main St" size="35" maxlength="255" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-field form-field">
                                ...
                                <div class="form-field__contents">
                                    <div class="textarea__container">
                                        <input type="text" name="billing_address_line2" id="billing_address_line2" class="entry" value="" placeholder="Apt 4B" size="35" maxlength="255" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-field form-field--required">
